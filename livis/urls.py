...
urlpatterns = [
    ...
    re_path(r'livis/v1/report/', include("reports.urls")),
    ...
    re_path(r'livis/v1/inspection_mobile_app/', include("inspection_mobile_app.urls")),
    re_path(r'livis/v1/data_capture/', include("data_capture.urls"))
